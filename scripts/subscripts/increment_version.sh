...
echo "const POC_APP_VERSION = '"$NEW_VERSION_STRING"';">po_contacts_flutter/lib/assets/constants/app_version.dart

git add po_contacts_flutter/pubspec.yaml
git add po_contacts_flutter/lib/assets/constants/app_version.dart
