...
class SyncModelSerializer {
  ...
  Future<SyncModel> getSyncModel() async {
    final SyncModel v = _syncModel ?? await _readSyncModel();
    return v;
  }
  ...
  Future<void> _saveDataToDisk() async {
    ...
    if (syncModel == null) {
      throw Exception('Error in _saveDataToDisk: syncModel is null');
    }
    final String syncModelStringValue = jsonEncode(<String, dynamic>{
      _JSON_KEY_SYNC_MODEL_INTERFACE_TYPE: syncModel._syncInterfaceType?.index,
      _JSON_KEY_SYNC_MODEL_ACCOUNT_NAME: syncModel._accountName,
      _JSON_KEY_SYNC_MODEL_INDEX_FILE_ID: syncModel.cloudIndexFileId,
      _JSON_KEY_SYNC_MODEL_LAST_SYNC_TIME: syncModel._lastSyncTimeEpochMillis,
      _JSON_KEY_SYNC_MODEL_LAST_SYNC_DATA_FILE_ID: syncModel._lastSyncDataFileId,
      _JSON_KEY_SYNC_MODEL_HAS_LOCAL_CHANGES: syncModel._hasLocalChanges,
      _JSON_KEY_SYNC_MODEL_HAS_REMOTE_CHANGES: syncModel._hasRemoteChanges,
    });
  ...
  Future<void> clearData() async {
    ...
    await (await _sharedPreferences).setString(_PREF_KEY_SYNC_MODEL_DATA, '');
